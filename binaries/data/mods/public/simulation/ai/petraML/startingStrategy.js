	...
	for (let ent of gameState.getOwnEntities().values())
	{
		...
		if (!pos)
		{
			...
			if (ent.isGarrisonHolder() && ent.garrisoned().length)
				API3.warn("PETRAML warning: support for garrisoned units inside garrisoned holders not yet implemented");
			continue;
		}
...
m.HQ.prototype.regionAnalysis = function(gameState)
{
	...
	{
		API3.warn("PETRAML error: it does not know how to interpret this map");
		return false;
	}

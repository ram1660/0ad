...
m.Config.prototype.setConfig = function(gameState)
{
	...
	// PETRAML usually uses the continuous values of personality.aggressive and personality.defensive
	...
	if (this.debug < 2)
		return;
	API3.warn(" >>>  PETRAML bot: personality = " + uneval(this.personality));
};

...
m.PetraBotML.prototype = new API3.BaseAI();

m.PetraBotML.prototype.CustomInit = function(gameState)
{
...
m.PetraBotML.prototype.OnUpdate = function(sharedScript)
{
	...
	{
		if (i == "AIMetadata")   // not used inside PETRAML
			continue;
	...
	{
		Engine.ProfileStart("PetraBotML bot (player " + this.player +")");
...
m.PetraBotML.prototype.Serialize = function()
{
	let savedEvents = {};
	for (let key in this.savedEvents)
	{
...
m.PetraBotML.prototype.Deserialize = function(data, sharedScript)
{

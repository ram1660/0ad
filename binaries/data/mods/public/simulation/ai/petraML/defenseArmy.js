...
m.DefenseArmy.prototype.update = function(gameState)
{
	...
	// var g_LastMTime = 0
	// API3.warn("In DefenseArmy.update!")
	// if (Engine.FileExists("simulation/ai/PetraML/mlData/answer.txt")){
	// 	API3.warn("Found file!")
	// 	let mTime = Engine.GetFileMTime("simulation/ai/PetraML/mlData/answer.txt");

	// 	if (mTime != g_LastMTime)

	// 	{
	// 		API3.warn("updating chance!")
	// 		let chance = parseFloat(Engine.ReadFile("simulation/ai/petraML/mlData/answer.txt"));
	// 		warn(chance.toString());
	// 		Engine.AppendToBuffer("a");
	// 		Engine.WriteToFile("simulation/ai/petraML/mlData/gameState.txt");
	// 		this.chance = chance

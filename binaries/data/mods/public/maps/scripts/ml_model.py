...
dataset = pd.read_csv('newFull.csv')
...
with open('D:\\Users\\micha\\Desktop\\ram-and-michael\\binaries\\data\mods\\public\\simulation\\ai\\petra\\classifier.pkl', 'wb') as f:
...
with open('D:\\Users\\micha\\Desktop\\ram-and-michael\\binaries\\data\\mods\\public\\simulation\\ai\\petra\\proba_rescale.pkl', 'wb') as f:
